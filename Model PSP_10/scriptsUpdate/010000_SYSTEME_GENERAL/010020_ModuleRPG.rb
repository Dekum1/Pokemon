    ...
    def animation_set_sprites(sprites, cell_data, position)
      ...
      0.upto(14) do |i|
        ...
        if position == 3
          ...
          sprite.y += 32 if @_registered_y < 240 and $battle_var.in_battle #déplace l'animation de 32px vers le bas si l'attaque est appliquée sur sur le Pokémon adverse
        end
